...
public class ReviewConverterTest {
  ...
  public void shouldCreateReview() {
    ReviewPatchPostDTO reviewDTO = new ReviewPatchPostDTO();
    reviewDTO.setRating(122);

    reviewDTO.setComment("Abc dcf jgs torba");
    reviewDTO.setClientName("Wojtek");
    reviewDTO.setHashRevID("12333");

    reviewDTO.setUserID(231);
    ...
    Review review = reviewConverter.createEntity(reviewDTO);
